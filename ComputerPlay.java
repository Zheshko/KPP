...
public class ComputerPlay extends GameWindow{
	...
	public int autoBot()
	{
		if(turn == 1)
		{
			...
			logic = new Logic(botNumber1.toCharArray(), turn, 
					correctPlayerNumber, correctBotNumber);
		...
		else
		{
			...
			logic = new Logic(botNumber2.toCharArray(), turn, 
					correctPlayerNumber, correctBotNumber);
			Thread thread = new Thread(logic);
			thread.start();
			try {
	...
	protected void MakeTurn() {
    		turn = 1;
    		logic = new Logic(enteredNumberLabel.getText().toCharArray(), turn, 
					correctPlayerNumber, correctBotNumber);
			Thread thread = new Thread(logic);
			thread.start();
			try {
