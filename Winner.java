...
public class Winner {
  ...
  public void Show() {
    ...
    if (mode == 1) {
      if (winner == 1)
        winnerLabel.setText("Игрок 1 выиграл!");
      if (winner == 2)
        winnerLabel.setText("Игрок 2 выиграл!");
      if (winner == 3)
        winnerLabel.setText("Ничья!");
    } else if (mode == 5) {
      if (winner == 1)
        winnerLabel.setText("Компьютер 1 выиграл!");
      if (winner == 2)
        winnerLabel.setText("Компьютер 2 выиграл!");
      if (winner == 3)
        winnerLabel.setText("Ничья!");
    } else {
      if (winner == 1)
        winnerLabel.setText("Вы выиграли!");
      if (winner == 2)
        winnerLabel.setText("Компьютер выиграл!");
      if (winner == 3)
        winnerLabel.setText("Ничья!");
    }
