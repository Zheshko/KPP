...
public class Number {
	...
	int num=0;
	Number(Display display,Shell shell,int i)
	{			
		...
		Image backToMenuImage = new Image(display, "C:/Users/Anastasia/workspace/BoolsAndCows/Images/back2.png");
	    ...
	    if(i==0) textLabel.setText("Загадайте число, Игрок 1");
	    else if(i==1) textLabel.setText("Загадайте число, Игрок 2");
	    else textLabel.setText("Загадайте число");
		...
		Font boldFont1 = new Font( enteredNumberLabel.getDisplay(), new FontData( "Arial", 40, SWT.NORMAL ) );
		...
		buttonOkey.addSelectionListener(
	            new org.eclipse.swt.events.SelectionAdapter() {
	                public void widgetSelected(
	                        org.eclipse.swt.events.SelectionEvent e) {
	                	if(num==4) {
	                		if(i==0){string1=enteredNumberLabel.getText();num=0;Number number=new Number(display,shell,1);}
	                		else if(i==1){string2=enteredNumberLabel.getText();num=0;Players players=new Players(display,shell,string1,string2);}
	                		else {string1=enteredNumberLabel.getText();string2=CreateBotNumber();num=0;ComputerPlay computer=new ComputerPlay(display,shell,string1,string2,i);}
	                	}
	                }
	            });
