	...
	buttonOkey.addSelectionListener(
            new org.eclipse.swt.events.SelectionAdapter() {
                public void widgetSelected(
                        org.eclipse.swt.events.SelectionEvent e) {
                	if(num==4) {
                		if(i==0){string1=enteredNumberLabel.getText();num=0;Number number=new Number(display,shell,1);number.Show();}
                		else if(i==1){string2=enteredNumberLabel.getText();num=0;Players players=new Players(display,shell,string1,string2);players.Show();}
                		else {string1=enteredNumberLabel.getText();string2=CreateBotNumber();num=0;ComputerPlay computer=new ComputerPlay(display,shell,string1,string2,i);computer.Show();}
                	}
                }
            });
